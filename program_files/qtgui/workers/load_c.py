...
COMPILED_CODE_PATH = os.path.abspath(os.path.join(THIS_PATH, "..", "..", "CRAM", "outs19.txt"))


class LoadCompiledThread(threading.Thread):
    """
    ...
    def run(self):
        ...
        """
        try:
            load_to_hyperterminal(COMPILED_CODE_PATH, logger=self.log)
